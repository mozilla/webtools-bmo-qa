...
rlJournalStart
    rlPhaseStartSetup
        ...
        # rlRun $LOG "cp t/config/localconfig ." 0 "Copying localconfig file into right place"
        # rlRun $LOG "chmod 644 localconfig" 0 "Setting permissions on localconfig file"
